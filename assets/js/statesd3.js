...
function state_chart(data) {

    const CHART_WIDTH = 1200;
    const CHART_HEIGHT = 601;

    let x = d3.scaleBand().rangeRound([0, CHART_WIDTH]).padding(0.2);
    ...
    let chart1 = chartContainer1.append('g')
    ...
    //text labels on bars
    chartContainer1.append('g').selectAll("text")
        .data(data)
        .enter()
        .append("text")
        .text(function (d) { return Math.round(d.Deaths * 100) / 100 })
        .attr('x', (data, i) => i * 120 + 40)
        .attr('y', (data) => y(data.Deaths) + 30)
        .attr("font-family", "sans-serif")
        .attr("font-size", "15px")
        .attr("fill", "white")
}
...
function handlechange() {
    ...
    var data = state_data.filter(function (d) {
        return d.State__1 === state;
    });
...
selectcounty.onchange = handlechange1;

function county_chart(data) {
    ...
    let chart3 = chartContainer3.append('g')
    ...
    let chart4 = chartContainer4.append('g')
...
function handlechange1() {
    d3.select(".modal1").selectAll('svg').selectAll('g').remove();
    let county = document.getElementById("selectcounty").value
    ...
    console.log(county)
    var data = county_data.filter(function (d) {
